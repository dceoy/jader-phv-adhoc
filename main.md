...
About the HLTs significantly associated with incretin-based drugs, mixed effects logistic regressions were performed.
Mixed effects


The logistic regression model includes occurrence of each ADEs as an outcome variable.


use of DPP-4 inhibitors, use of GLP-1 agonists, hyperglycemia, concomitant suspected drug, age and sex as predictor variables, and occurrence of each ADEs as an outcome variable.
